...
Next, we created a table of continents to create a relationship between the country and the continent.

We then calculated key metrics such as average life expectancy, population statistics, GDP and total health expenditure. We analysed trends in life expectancy over time, identified correlations with economic and health indicators, and created 4 different dashboards to visualise the results.
